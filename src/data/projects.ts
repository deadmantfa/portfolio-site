...
export const projects: ProjectCaseStudy[] = [
  ...
  },
  {
    ...
    narrative: {
      vision: 'Digitize the end-to-end supply chain of a complex subscription-based food service to enable hyper-growth through operational automation, data-driven decision making, and real-time supply chain visibility across multiple distribution centers and partner networks.',
      execution: 'Developed a comprehensive custom ERP system that integrated CRM, logistics, and kitchen management into a single technical authority, connecting restaurants, logistics partners, and customer platforms seamlessly. Implemented real-time inventory tracking using IoT sensors on refrigeration units, dynamic pricing engines that continuously adjusted prices based on demand elasticity and current inventory levels, and automated delivery route optimization using machine learning algorithms that minimized travel time while respecting delivery time windows. Built sophisticated demand forecasting models using time series analysis and external data sources that predicted subscriber behavior weeks in advance, enabling proactive kitchen staffing decisions and data-driven ingredient procurement planning.',
      result: 'The system automated 80% of manual data entry, allowing the company to scale from 1,000 to 10,000 active daily subscribers while maintaining 99.9% on-time delivery rates across the expanded region. Reduced kitchen waste by 35% through predictive demand forecasting and enabled the company to expand successfully to 3 new product verticals seamlessly. Operational efficiency gains and reduced overhead freed up management resources to focus on customer acquisition, retention, and market expansion strategies.'
    },
    blueprint: {
      type: 'hub-and-spoke',
      nodes: 8,
  ...
  },
  {
    ...
    narrative: {
      vision: 'Secure and revolutionize mobile commerce through architectural integrity and innovative feature sets in a highly regulated environment while enabling cutting-edge capabilities on resource-constrained mobile devices.',
      execution: 'Implemented comprehensive security protocols alongside distributed compute solutions to balance strict safety requirements with high-end features users demanded. Developed custom MFA layers using SMS and mobile callbacks specifically designed for regional mobile payment patterns. Built async video processing render farm using AWS EC2 and Blender to generate professional-grade video summaries, maintaining 99.99% uptime while handling millions in daily transaction volumes with full PCI DSS compliance. Engineered custom security frameworks that handled payment processing while remaining compliant with strict data residency and regulatory requirements.',
      result: 'The platform achieved full PCI compliance and successfully processed millions in transactions with zero security breaches across multiple years of operation. Pioneered mobile-first payment solutions that reduced unauthorized transaction attempts by 95% while maintaining seamless, frictionless user experiences. Enabled mobile users to perform high-end video generation in under 60 seconds, setting new standards for mobile commerce capabilities in the region.'
    },
    blueprint: {
      type: 'monolith',
      nodes: 6,
