...
export const projects: ProjectCaseStudy[] = [
  ...
  },
  {
    ...
    narrative: {
      ...
      execution: [
        'Developed a comprehensive custom ERP system that integrated CRM, logistics, and kitchen management into a single technical authority, seamlessly connecting restaurants, third-party logistics providers, and customer platforms.',
        'Implemented real-time inventory tracking using IoT sensors on refrigeration units that monitored temperature and stock levels, dynamic pricing engines that continuously adjusted prices based on demand elasticity and current inventory levels, and automated delivery route optimization using advanced machine learning algorithms that minimized travel time while respecting delivery time windows and traffic patterns.',
        'Built sophisticated demand forecasting models using time series analysis, seasonal patterns, and external data sources that predicted subscriber behavior weeks in advance, enabling proactive kitchen staffing decisions and data-driven ingredient procurement planning.',
      ],
      result: [
        'The system automated 80% of manual data entry, allowing the company to scale from 1,000 to 10,000 active daily subscribers while maintaining 99.9% on-time delivery rates across the expanded region. Reduced kitchen waste by 35% through predictive demand forecasting and enabled the company to expand successfully to 3 new product verticals seamlessly.',
        'Operational efficiency gains and reduced overhead freed up management resources to focus strategically on customer acquisition, retention, and market expansion opportunities. The platform became a model for efficient supply chain management in the food service industry.',
      ]
    },
    blueprint: {
      type: 'hub-and-spoke',
  ...
  },
  {
    ...
    narrative: {
      ...
      execution: [
        'Built a highly modular Node.js backend with an extensible adapter pattern for integrating multiple banking APIs and payment gateways. The payment orchestration layer routed transactions through a prioritised list of gateway providers, retrying automatically on failure with idempotency keys ensuring no student was ever double-charged.',
        'Designed the application form as a canonical student profile that could be submitted once and distributed to multiple selected colleges simultaneously, with each institution\'s records fully isolated behind the multi-tenant schema boundary.',
      ...
      result: [
        'The platform processed over $50M in transactions in its first year with 99.99% payment gateway uptime and zero security incidents. Students could apply to multiple colleges through a single form, dramatically reducing abandonment.',
        'College administrators gained real-time ERP visibility that cut admission processing time by 60% and eliminated manual reconciliation. Onboarded 50+ institutions in 3 months and became the go-to admissions and payments platform in the region.',
      ]
    },
    blueprint: {
      type: 'microservices',
  ...
  },
  {
    ...
    narrative: {
      ...
      execution: [
        'Built a custom "Creative Quotient" (CQ) engine using machine learning for collaborative scoring that identified high-potential collaborators based on portfolio aesthetics and skill complementarity. Implemented a real-time messaging layer enabling organic collaboration at scale with full-text search and conversation threading.',
        'Pioneered a color-based discovery system using Elasticsearch for multi-dimensional color vector queries, enabling creatives to find portfolios by aesthetic palette. Implemented serverless image processing using AWS Lambda that reduced infrastructure costs by 70% while supporting 20+ properties across photography, design, illustration, and video verticals.',
      ],
      result: [
        'The platform maintained 100% uptime during rapid 10x growth and became the leading creative network in the region. Facilitated 100,000+ creatives discovering each other through color-based search and algorithmic recommendations, with 90% user satisfaction.',
        'Platform innovations became industry benchmarks, with color-based discovery being adopted by other platforms. Successfully managed complex technical challenges of growing from 10K to 100K+ active creators while maintaining performance.',
      ]
    },
    blueprint: {
      type: 'serverless',
  ...
  },
  {
    ...
    narrative: {
      ...
      execution: [
        'Implemented comprehensive security protocols alongside distributed compute solutions to balance strict safety requirements with high-end features users demanded. Developed custom MFA layers using SMS and mobile callbacks specifically designed for regional mobile payment patterns and user demographics.',
        'Built async video processing render farm using AWS EC2 and Blender to generate professional-grade video summaries, maintaining 99.99% uptime while handling millions in daily transaction volumes with full PCI DSS compliance.',
        'Engineered custom security frameworks that handled payment processing while remaining compliant with strict data residency and regulatory requirements specific to the region. Developed proprietary fraud detection systems using behavioral analytics to identify suspicious patterns in real-time.',
      ],
      result: [
        'The platform achieved full PCI compliance and successfully processed millions in transactions with zero security breaches across multiple years of operation, becoming a trusted payment provider.',
        'Pioneered mobile-first payment solutions that reduced unauthorized transaction attempts by 95% while maintaining seamless, frictionless user experiences that drove adoption. Enabled mobile users to perform high-end video generation in under 60 seconds, setting new standards for mobile commerce capabilities in the region and attracting premium customers seeking innovative features.',
      ]
    },
    blueprint: {
      type: 'monolith',
